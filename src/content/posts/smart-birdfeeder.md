...
<figure class="img-row" contenteditable="false">
...
When all was said and done, I ended up with a pretty cool system:

- **Python/Pi:**

- A script monitors a PIR motion sensor. When a bird arrives, it triggers an interrupt, snaps a photo, and sends it to Firebase (a cloud storage/database). - Another script monitors the Firebase database and checks for flags corresponding to commands from the app.
